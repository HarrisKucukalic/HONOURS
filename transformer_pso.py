...
class Transformer_PSO_Model:
    ...
    def __init__(self, region: str, input_shape: int):
        ...
        self.best_hyperparameters = None  # To store best params for saving
        print(f"Initialized Transformer_PSO_Model wrapper for {self.region}.")

    def train_model(self, X_train, y_train, X_val, y_val, search_space, pso_n_particles, pso_iters):
        """
        ...
        print("\n--- Step 2: Decoding Hyperparameters ---")
        ...
        print("\n--- Step 3: Training Final Transformer Model with Optimal Hyperparameters ---")
        ...
        # Optional: Combine training and validation data for the final run
        ...
        self.final_model.train_model(
            ...
            X_val=None,
            y_val=None,
            **training_params  # Pass all training params at once
        )
    ...
    def save_model(self, directory: str):
        """
        Saves the final trained model's state dictionary.
        """
        if self.final_model:
            if not os.path.exists(directory):
                os.makedirs(directory)
