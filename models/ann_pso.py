...
class ANN_PSO_Model:
    def __init__(self, region: str, input_shape: int):
        ...
        print(f"Initialised ANN_PSO_Model wrapper for {self.region}.")
    def run_training_loop(self, X_train: np.ndarray, y_train: np.ndarray, X_val: np.ndarray, y_val: np.ndarray, search_space: Dict[str, Tuple[Union[int, float], Union[int, float]]], pso_n_particles: int, pso_iters: int):
        print("\nFinding Optimal Hyperparameters using PSO")
        ...
        print("\nDecoding and Separating Hyperparameters")
        # Decode the architecture from the raw PSO results
        ...
        # Train the final model using the combined data
